...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.addressed_as_custom'
        db.alter_column('contacts_contact', 'addressed_as_custom', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Contact.addressed_as_custom'
        db.alter_column('contacts_contact', 'addressed_as_custom', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['categories.Category']"}),
            ...
            'reference': ('django.db.models.fields.CharField', [], {'max_length': '100', 'default': "''", 'blank': 'True'}),
