...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.migration_id'
        db.add_column('contacts_contact', 'migration_id',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.migration_id'
        db.delete_column('contacts_contact', 'migration_id')
