...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.is_artist'
        db.add_column('contacts_contact', 'is_artist',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.is_artist'
        db.delete_column('contacts_contact', 'is_artist')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'to': "orm['categories.Category']", 'null': 'True', 'symmetrical': 'False'}),
