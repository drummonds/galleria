...
class ContactTest(WebTest):
    def test_factory_create(self):
        ...
        self.assertTrue(isinstance(instance, Contact))
    ...
    def test_list_view(self):
        ...
        """
        instance = mommy.make(Contact)
        response = self.app.get(reverse('contact_list'))
    ...
    def test_create_view(self):
        ...
        """
        response = self.app.get(reverse('contact_create'))
        new_name = 'A freshly created thing'

        # check that we don't already have a model with this name
        self.assertFalse(Contact.objects.filter(name=new_name).exists())
        ...
        instance = Contact.objects.get(name=new_name)
    ...
    def test_update_view(self):
        ...
        """
        instance = mommy.make(Contact)
        response = self.app.get(reverse('contact_update', kwargs={'pk': instance.pk, }))
        ...
        instance = Contact.objects.get(pk=instance.pk)
        self.assertEqual(instance.name, new_name)
    ...
    def test_delete_view(self):
        ...
        instance = mommy.make(Contact)
        pk = instance.pk
        response = self.app.get(reverse('contact_delete', kwargs={'pk': pk, }))
